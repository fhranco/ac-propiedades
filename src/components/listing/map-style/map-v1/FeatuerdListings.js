          ...
          <div className={colstyle ? "listing-style1 listCustom listing-type" : "listing-style1"}>
            <div className="list-thumb"    >
              ...
              <div className="list-price">
                {listing.price} {listing.forRent ? <span>/ mes</span> : ""}
              </div>
            </div>
            <div className="list-content">
              ...
              <div className="list-meta d-flex align-items-center">
                <a href="#">
                  <span className="flaticon-bed" /> {listing.bed} dorm
                </a>
                <a href="#">
                  <span className="flaticon-shower" /> {listing.bath} {listing.bath === 1 ? 'baño' : 'baños'}
                </a>
                <a href="#">
              ...
              <div className="list-meta2 d-flex justify-content-between align-items-center">
                <span className="for-what">{listing.forRent ? "En Arriendo" : "En Venta"}</span>
