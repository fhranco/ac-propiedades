   ...
   const filterFunctions={
    ...
    useEffect(() => {
      ...
      if (currentSortingOption == 'Newest') {
        ...
        const sorted = [...filteredData].sort((a,b)=>a.price.replace(/[^0-9]/g, '') - b.price.replace(/[^0-9]/g, ''))
        setSortedFilteredData(sorted)

        
      } 
      else if (currentSortingOption.trim() == 'Price High') {
        const sorted = [...filteredData].sort((a,b)=>b.price.replace(/[^0-9]/g, '') - a.price.replace(/[^0-9]/g, ''))
        setSortedFilteredData(sorted)
